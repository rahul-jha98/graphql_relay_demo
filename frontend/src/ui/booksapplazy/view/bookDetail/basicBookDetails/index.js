...
const Name = ({ bookNodeRef }) => {
    const book = useFragment(graphql`
        fragment basicBookDetailsName2Fragment on Book
        {
            name
        }
    `, bookNodeRef);
...
const Year = ({ bookNodeRef }) => {
    const book = useFragment(graphql`
        fragment basicBookDetailsYear2Fragment on Book
        {
            year
        }
    `, bookNodeRef);
...
const Isbn = ({ bookNodeRef }) => {
    const book = useFragment(graphql`
        fragment basicBookDetailsIsbn2Fragment on Book
        {
            isbn
        }
    `, bookNodeRef);
...
const Description = ({ bookNodeRef }) => {
    const book = useFragment(graphql`
    fragment basicBookDetailsDescription2Fragment on Book
    {
        description
    }
    `, bookNodeRef);
...
export default ({ bookNodeRef }) => {
    const book = useFragment(graphql`
        fragment basicBookDetails2Fragment on Book
        {
            ...basicBookDetailsName2Fragment
            ...basicBookDetailsYear2Fragment
            ...basicBookDetailsIsbn2Fragment
            ...basicBookDetailsDescription2Fragment
            ...authorDetails2Fragment
        }
    `, bookNodeRef);

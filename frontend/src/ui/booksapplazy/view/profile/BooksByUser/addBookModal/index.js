...
const AddBookMutation = graphql`
  mutation addBookModal2Mutation($name: String!, $description: String!, $year: Int!, $isbn: String!, $authorId: ID!, $connections: [ID!]!) {
    addBook(name: $name,
...
export default function AddBookDialog({ closeModal }) {
    ...
    const onSubmit = (data) => {
        ...
        const allBooksConnectionId = ConnectionHandler.getConnectionID(ROOT_ID, "PaginatedList2_books");
        const booksByAuthorConnectionId = ConnectionHandler.getConnectionID(ROOT_ID,
                                                                             "PaginatedList2_books", 
                                                                             { author_id: authorId });
